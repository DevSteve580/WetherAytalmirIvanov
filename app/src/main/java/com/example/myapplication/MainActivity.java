        ...
        search_floating.setOnClickListener(new View.OnClickListener() {
            ...
            private void api_key(final String City) {
                ...
                Request request = new Request.Builder()
                        .url("http://api.openweathermap.org/data/2.5/weather?q="+City+"&appid=e3143fff27b63a456c945502951be8a4")
                        .get()
                        .build();
            ...
            private void setImage(final ImageView view_weather,final String icons) {
                switch (icons) {
